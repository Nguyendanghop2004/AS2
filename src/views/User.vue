        ...
        <div class="row">
            ...
            <div class="col-2 p-3 bg-dark text-white vh-100">
                ...
                <nav class="nav flex-column mt-4">
                    ...
                    <router-link class="nav-link text-light hover-effect" :to="{ name: 'user' }">Người
                        Dùng</router-link>
                    <router-link class="nav-link text-light hover-effect" :to="{ name: 'order' }">Đơn hàng</router-link>
                    <router-link class="nav-link text-light hover-effect" :to="{ name: 'thongke' }">Thống
                        kê</router-link>
                </nav>
            </div>
            ...
            <div class="col-10 p-4">
                ...
                <router-link class="btn btn-success mb-3" :to="{ name: 'themUser' }">➕ Thêm mới</router-link>
                        ...
                        <tr v-for="product in products" :key="product.id">
                            ...
                            <td>
                                ...
                                <RouterLink class="btn btn-info btn-sm me-2"
                                    :to="{ name: 'listViewUser', params: { id: product.id } }">
                                    🔍 Chi tiết
                                </RouterLink>
                                <RouterLink class="btn btn-warning btn-sm"
                                    :to="{ name: 'suaUser', params: { id: product.id } }">
                                    ✏️ Sửa
                                </RouterLink>
                                <RouterLink class="btn  btn-sm" :to="{ name: 'orderUser', params: { id: product.id } }">
                                    Đơn hàng
                                </RouterLink>
                            </td>
                        </tr>
